...
namespace DocumentManagement.Domain.Migrations
{
    ...
    [Migration("20211222114952_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DocumentManagement.Data.Entities.ManageWorkflow.WorkFlowParticipant", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("CanViewToApprove")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("WorkFlowParticipant");
                });

            modelBuilder.Entity("DocumentManagement.Data.Entities.ManageWorkflow.WorkFlowParticipants", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("WorkFlowParticipants");
                });

            modelBuilder.Entity("DocumentManagement.Data.Entities.ManageWorkflow.WorkFlowRoleParticipant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("WorkFlowRoleParticipant");
                });

            modelBuilder.Entity("DocumentManagement.Data.Entities.ManageWorkflow.Workflow", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DocumentManagement.Data.Entities.ManageWorkflow.WorkflowHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DocumentManagement.Data.Entities.ManageWorkflow.WorkflowUserParticipant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("WorkflowUserParticipant");
                });
            ...
            modelBuilder.Entity("DocumentManagement.Data.Entities.ManageWorkflow.WorkFlowParticipant", b =>
                {
                    ...
                    b.HasOne("DocumentManagement.Data.Entities.ManageWorkflow.Workflow", "Workflow")
                        .WithMany("WorkFlowParticipant")
            ...
            modelBuilder.Entity("DocumentManagement.Data.Entities.ManageWorkflow.WorkFlowRoleParticipant", b =>
                {
                    b.HasOne("DocumentManagement.Data.Role", null)
                        .WithMany("WorkFlowRoleParticipant")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("DocumentManagement.Data.Entities.ManageWorkflow.WorkflowUserParticipant", b =>
                {
                    b.HasOne("DocumentManagement.Data.User", null)
                        .WithMany("WorkflowUserParticipant")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("DocumentManagement.Data.Entities.ManageWorkflow.Workflow", b =>
                {
                    b.Navigation("WorkFlowParticipant");
                });
            ...
            modelBuilder.Entity("DocumentManagement.Data.Role", b =>
                {
                    ...
                    b.Navigation("WorkFlowRoleParticipant");
                });
            ...
            modelBuilder.Entity("DocumentManagement.Data.User", b =>
                {
                    ...
                    b.Navigation("WorkflowUserParticipant");
                });
