    ...
    public partial class Intial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkFlowRoleParticipant", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WorkFlowRoleParticipant_Roles_RoleId",
                        column: x => x.RoleId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkflowUserParticipant", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WorkflowUserParticipant_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DocumentId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    WorkflowMethod = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Workflow_Documents_DocumentId",
                        column: x => x.DocumentId,
                        principalTable: "Documents",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Workflow_Users_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkFlowParticipants", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WorkFlowParticipants_Documents_DocumentId",
                        column: x => x.DocumentId,
                        principalTable: "Documents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WorkFlowParticipants_Users_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkflowHistory_Users_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderNumber = table.Column<int>(type: "int", nullable: false),
                    CanViewToApprove = table.Column<bool>(type: "bit", nullable: false),
                    ApprovalStatus = table.Column<int>(type: "int", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkFlowParticipant", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WorkFlowParticipant_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_WorkFlowParticipant_Workflow_WorkflowId",
                        column: x => x.WorkflowId,
                        principalTable: "Workflow",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkFlowParticipant_UserId",
                table: "WorkFlowParticipant",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkFlowParticipant_WorkflowId",
                table: "WorkFlowParticipant",
                column: "WorkflowId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkFlowParticipants_CreatedBy",
                table: "WorkFlowParticipants",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_WorkFlowParticipants_DocumentId",
                table: "WorkFlowParticipants",
                column: "DocumentId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkFlowRoleParticipant_RoleId",
                table: "WorkFlowRoleParticipant",
                column: "RoleId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkflowUserParticipant_UserId",
                table: "WorkflowUserParticipant",
                column: "UserId");
        }
